...
export default function DoubleDoubleTitle() {
    return (
        <div className="group pt-[2%] text-center cursor-default overflow-hidden py-8"> {/* Added overflow-hidden */}
            {/* 3D Text Effect */}
            <div className="relative inline-block transform transition-all duration-500 group-hover:scale-[1.05]"> {/* Reduced scale */}
                {/* Shadow layer */}
                <h1 className="text-blue-600 opacity-30 absolute inset-0 translate-x-2 translate-y-2 
                    text-[52px] md:text-[48px] sm:text-[44px] xs:text-[40px] 
                    font-bold tracking-tight">
                    The Double Double
                </h1>
                {/* Main text */}
                <h1 className="relative text-blue-500 group-hover:text-blue-400
                    text-[52px] md:text-[48px] sm:text-[44px] xs:text-[40px] 
                    font-bold tracking-tight 
            ...
            <div className="relative mt-2 md:mt-0 sm:mt-0 mx-auto max-w-[90%]"> {/* Added max-width and mx-auto */}
                <span className="font-roboto font-bold text-white/80 
                    text-[20px] md:text-[18px] sm:text-[16px] xs:text-[15px]
                    relative inline-block
                    before:content-[''] before:absolute before:-bottom-1 before:left-0 
                    before:w-0 before:h-0.5 before:bg-blue-400 before:opacity-70
